...
export const CANONICAL_HOSPITAL_MANAGEMENT_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'patient_panel_reports', label: 'Patient / Panel Reports', icon: 'FileText' },
      { id: 'billing_reports', label: 'Billing Reports', icon: 'FileSpreadsheet' },
      { id: 'collection_reports', label: 'Collection Reports', icon: 'Coins' },
      { id: 'admission_reports', label: 'Admission Reports', icon: 'LineChart' },
...
export const FRONT_DESK_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    title: 'REPORTS',
    items: [
      { id: 'front_desk_billing_reports', label: 'Front Desk / Billing Reports', icon: 'BarChart2' },
      ...
      { id: 'fd_discount_report', label: 'Discount / Panel Discount Report', icon: 'Tag' },
      { id: 'fd_refund_void_report', label: 'Refund / Void / Reversal Report', icon: 'RotateCcw' },
      { id: 'fd_department_revenue', label: 'Department / Service Revenue', icon: 'Building2' },
      { id: 'fd_admission_payment_collections', label: 'Admission Payment Collections', icon: 'CreditCard' },
      { id: 'fd_panel_payer', label: 'Panel / Payer Reporting', icon: 'Landmark' },
      { id: 'fd_receipt_exceptions', label: 'Receipt Reprint / Exception Log', icon: 'Printer' },
      { id: 'fd_cashier_performance', label: 'User / Cashier Performance', icon: 'Users' },
    ],
  },
  {
...
export const ADMISSION_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'admission_reports', label: 'Admission Reports', icon: 'LineChart' },
      { id: 'adm_daily_summary', label: 'Admission Daily Summary', icon: 'LayoutDashboard' },
      { id: 'adm_register_report', label: 'Admission Register', icon: 'ClipboardList' },
      { id: 'adm_census', label: 'Inpatient Census', icon: 'Users' },
      { id: 'adm_bed_occupancy', label: 'Bed Occupancy / Ward Utilization', icon: 'Bed' },
      { id: 'adm_bed_transfers', label: 'Bed / Ward / Room Transfer History', icon: 'ArrowLeftRight' },
      { id: 'adm_length_of_stay', label: 'Length of Stay', icon: 'Clock' },
      { id: 'adm_service_consumption', label: 'Admission Service Consumption', icon: 'Boxes' },
      ...
      { id: 'adm_payment_request_status', label: 'Hospital Payment Request & Status', icon: 'CreditCard' },
      { id: 'adm_pharmacy_requests', label: 'Pharmacy Medicine Requests', icon: 'Pill' },
      { id: 'adm_medicine_fulfillment', label: 'Medicine Request Fulfillment', icon: 'ClipboardCheck' },
      { id: 'adm_high_value_approvals', label: 'High-Value Medicine Approval', icon: 'ShieldAlert' },
      { id: 'adm_pharmacy_clearance_status', label: 'Pharmacy Clearance Status', icon: 'PackageCheck' },
    ],
  },
  {
